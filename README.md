## boost_sml_vendor (kilted) - 1.1.13-1

The packages in the `boost_sml_vendor` repository were released into the `kilted` distro by running `/usr/bin/bloom-release boost_sml_vendor -y --rosdistro kilted` on `Mon, 23 Feb 2026 07:09:04 -0000`
...
- rosdistro version: `1.1.11-2`
- old version: `1.1.11-2`
...
## boost_sml_vendor (jazzy) - 1.1.13-1

The packages in the `boost_sml_vendor` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release boost_sml_vendor -y --rosdistro jazzy` on `Mon, 23 Feb 2026 07:07:44 -0000`
...
## boost_sml_vendor (rolling) - 1.1.12-1

The packages in the `boost_sml_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release boost_sml_vendor --rosdistro rolling` on `Wed, 05 Nov 2025 14:57:18 -0000`
...
## boost_sml_vendor (rolling) - 1.1.11-1
